 ...
 * Provides methods to retrieve and manage class schedule information.
 */
public interface ScheduleRepository {
     ...
     *
     * @param schedule The schedule with updated data
     ...
     * @param teacherId The unique identifier of the teacher (for validation)
     */
     ...
     *
     * @param ids       The list of schedule IDs to check
     * @param teacherId The unique identifier of the teacher
     ...
     * @param excludeScheduleId Optional schedule ID to exclude from the check (for updates)
