...
public class GroupAssignmentValidationException extends ListErrorMessageBaseException {

    public GroupAssignmentValidationException(List<ErrorMessage> errors) {
