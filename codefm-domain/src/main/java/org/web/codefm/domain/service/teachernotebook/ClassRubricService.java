...
/**
 * Service interface for class rubric assignment and student criterion assignment operations.
 * Acts as an intermediary between use cases and repositories.
 */
public interface ClassRubricService {
    ...
    /**
     * Assigns a rubric to a class. Validates teacher ownership of both class and rubric,
     * and that the assignment does not already exist.
     *
     * @param classId  The unique identifier of the class
    ...
    /**
     * Soft-deletes a class-rubric assignment.
     *
     ...
     * Validates ownership, student enrollment, criterion belonging to rubric, and no duplicates.
     *
    ...
    /**
     * Updates the criterion assigned to a student within a class-rubric assignment.
     * Validates that the new criterion belongs to the same rubric.
     *
