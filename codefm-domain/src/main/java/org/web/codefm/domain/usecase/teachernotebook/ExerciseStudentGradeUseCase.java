...
/**
 * Interface that defines exercise student grade operations for teachers.
 * Handles student grade data retrieval and management.
 */
public interface ExerciseStudentGradeUseCase {
