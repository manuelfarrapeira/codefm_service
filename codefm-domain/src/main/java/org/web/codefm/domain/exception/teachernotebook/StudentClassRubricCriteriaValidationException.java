...
public class StudentClassRubricCriteriaValidationException extends ListErrorMessageBaseException {
    public StudentClassRubricCriteriaValidationException(List<ErrorMessage> errors) {
