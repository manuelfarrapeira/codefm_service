...
public class ExerciseDocumentValidationException extends ListErrorMessageBaseException {
    public ExerciseDocumentValidationException(List<ErrorMessage> errors) {
