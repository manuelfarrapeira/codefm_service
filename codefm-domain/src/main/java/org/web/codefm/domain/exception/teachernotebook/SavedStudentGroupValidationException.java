...
public class SavedStudentGroupValidationException extends ListErrorMessageBaseException {
    public SavedStudentGroupValidationException(List<ErrorMessage> errors) {
