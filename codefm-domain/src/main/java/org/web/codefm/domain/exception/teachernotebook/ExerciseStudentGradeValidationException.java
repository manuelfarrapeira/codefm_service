...
public class ExerciseStudentGradeValidationException extends ListErrorMessageBaseException {
    public ExerciseStudentGradeValidationException(List<ErrorMessage> errors) {
