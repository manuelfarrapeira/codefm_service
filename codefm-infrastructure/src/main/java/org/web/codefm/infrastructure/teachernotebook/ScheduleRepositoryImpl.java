...
public class ScheduleRepositoryImpl implements ScheduleRepository {
    ...
    public List<Schedule> findByClassId(Integer classId) {
        return scheduleMapper.toModelList(
                scheduleJPARepository.findByClassIdAndDeletionDateIsNullOrderByDayAscStartAsc(classId)
        );
    }
    ...
    @Override
    public boolean existsOverlappingSchedule(Integer classId, Integer day, LocalTime start, LocalTime end, Integer excludeScheduleId) {
        if (excludeScheduleId != null) {
            return scheduleJPARepository.existsOverlappingScheduleExcluding(classId, day, start, end, excludeScheduleId);
        }
